...
namespace Toolbox
{
    ...
    public static class AStar
    {
        ...
        public static List<Vector3Int> FindPathClosest(Tilemap map, Vector3Int start, Vector3Int goal)
        {
            ...
            return AStar.FindPath(new FourDirectionGraph(map), start, goal, Heuristic.ManhattanDist);//Vector3Int.Distance);
        }
        ...
        static HashSet<Vector3Int> OpenCells(Tilemap map, Vector3Int start, Vector3Int goal)
        {
            ...
            {
                float dist = Heuristic.ManhattanDist(goal, next);   // Vector3Int.Distance
        ...
        static Vector3Int ClosestCell(HashSet<Vector3Int> openCells, Vector3Int start, Vector3Int goal)
        {
            ...
            {
                float dist = Heuristic.ManhattanDist(start, c); //Vector3Int.Distance
        ...
        {
            return FindPath(new FourDirectionGraph(map), start, goal, Heuristic.ManhattanDist); //(Vector3Int.Distance
        }
